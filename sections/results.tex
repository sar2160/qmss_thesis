...
\begin{figure}[h!]
  \centering
  \caption{}
  \includegraphics[width=.6\textwidth]{citywide_var_decomp}
\end{figure}
...
\end{table}
 ...
 \begin{figure}[h!]
   ...
   \begin{subfigure}{.4\textwidth}
     \centering
     \includegraphics[width=.4\linewidth]{mn_centroids}
   ...
   \begin{subfigure}{.4\textwidth}
     ...
     \includegraphics[width=.4\textwidth]{mn_f_score_map}
   \end{subfigure}
\end{figure}
...
\begin{figure}[h!]
  ...
  \includegraphics[width=.6\textwidth]{grid_MSE}
\end{figure}
